...
class TestMaxInteger(unittest.TestCase):
    """unittest of max_integer program"""
    ...
    def test_positives(self):
        ...
        test_list = ["Juan", "Suarez"]
        self.assertEqual(max_integer(test_list), "Suarez")
    ...
    def test_not_list(self):
        ...
        test_list = "Juan"
        self.assertEqual(max_integer(test_list), 'u')

        test_list = 'J'
        self.assertEqual(max_integer(test_list), 'J')
